...
final List<Point> allVertex = [
  ...
  Point(
    ...
    coordinate: ['-25.42907881', '-49.26757526'],
  ),
  Point(
    id: 10,
    name: "joinPoint",
    // coordinate: ['-25.4291833', '-49.2675305'],
    coordinate: ['-25.42920535', '-49.26751791'],
  ),
  Point(
    id: 11,
    name: "joinPoint",
    // coordinate: ['-25.4291966', '-49.2675567'],
    coordinate: ['-25.42921527', '-49.26754625'],
  ),
  Point(
    id: 12,
    name: "joinPoint",
  ...
  Point(
    ...
    coordinate: ['-25.42898900', '-49.26773142'],
  ),
  Point(
    id: 18,
    name: "joinPoint",
  ...
  Point(
    ...
    coordinate: ['-25.42888654', '-49.26771437'],
  ),
  Point(
    id: 20,
    name: "joinPoint",
