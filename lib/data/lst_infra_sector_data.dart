...
InfraSector infraSectorPredioHistorico = InfraSector(
  name: "Prédio Histórico da UFPR",
  entries: [
    Polyline(
      //parede diplomas/coafe
      points: [
    ...
    Polyline(
      //entrada prograd
      points: [
        LatLng(-25.42885174, -49.26780126),
        LatLng(-25.42883830, -49.26780746)
      ],
      borderStrokeWidth: 5,
      color: Colors.white,
...
List<InfraSector> lstInfraSector = [
  InfraSector(
    name: "Elevador B",
    entries: [
      Polyline(
        //elevador B, entrada principal
        points: [
  ...
  InfraSector(
    ...
    entries: [
      Polyline(
        points: [
          LatLng(-25.42930943, -49.26747772),
          LatLng(-25.42929951, -49.26745274),
        ],
        borderStrokeWidth: 5,
        color: Colors.white,
        borderColor: Colors.white,
  ...
  InfraSector(
    ...
    entries: [
      Polyline(
        //entrada elevador C, atendimento
        points: [
  ...
  InfraSector(
    name: "Escada Atendimento",
    entries: [
      Polyline(
        //entrada escada atendimento, frente atendimento
        points: [
          LatLng(-25.42894423, -49.26774313),
          LatLng(-25.42895530, -49.26773796)
        ],
        borderStrokeWidth: 5,
        color: Colors.white,
        borderColor: Colors.white,
      ...
      Polyline(
        // entrada escada atendimento, frente biblioteca
        points: [
          LatLng(
            -25.42889625,
            -49.26771467,
  ...
  InfraSector(
    name: "Espaço Aberto Interno Direito",
    entries: [
      Polyline(
        points: [
          LatLng(0, 0),
  ...
  InfraSector(
    name: "Espaço Aberto Interno Esquerdo",
    entries: [
      Polyline(
        //jardim aberto
        points: [
          LatLng(-25.42914245, -49.26761838),
          LatLng(-25.42913419, -49.26759855),
        ],
        borderStrokeWidth: 5,
        color: Colors.white,
        borderColor: Colors.white,
  ...
  InfraSector(
    name: "Escada Jardim Aberto",
    entries: [
      Polyline(
        //escada entrada esquerda
        points: [
          LatLng(-25.42917905, -49.26757928),
          LatLng(-25.42918703, -49.26759965),
        ],
        borderStrokeWidth: 5,
        color: Colors.white,
        borderColor: Colors.white,
